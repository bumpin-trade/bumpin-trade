...
export class State {
    ...
    constructor(state: StateAccount) {
        ...
        this.fundingFeeBaseRate =
            state.fundingFeeBaseRate.toBigNumberWithDecimals(
...
export class Market {
    ...
    public stableLoss: BigNumber;
    public stableUnsettleLoss: BigNumber;
    public shareShort: boolean;
    ...
    constructor(
        ...
        this.stableLoss =
            market.stableLoss.toBigNumberWithDecimals(stableCoinDecimals);
        this.stableUnsettleLoss =
            market.stableUnsettleLoss.toBigNumberWithDecimals(
                stableCoinDecimals,
            );
        this.shareShort = market.shareShort;
    }
}
...
export class BorrowingFee {
    ...
    constructor(borrowingFee: BorrowingFeeAccount, coinDecimals: number) {
        this.totalBorrowingFee =
            borrowingFee.totalBorrowingFee.toBigNumberWithDecimals(
                coinDecimals,
            );
...
export class FeeReward {
    ...
    constructor(feeReward: FeeRewardAccount, coinDecimals: number) {
        this.feeAmount =
            feeReward.feeAmount.toBigNumberWithDecimals(coinDecimals);
...
export class Rewards {
    ...
    constructor(rewards: RewardsAccount, coinDecimals: number) {
        ...
        this.poolTotalRewardsAmount =
            rewards.poolTotalRewardsAmount.toBigNumberWithDecimals(
                coinDecimals,
            );
...
export class UserRewards {
    ...
    constructor(userRewards: UserRewardsAccount, coinDecimals: number) {
        this.totalClaimRewardsAmount =
            userRewards.totalClaimRewardsAmount.toBigNumberWithDecimals(
                coinDecimals,
            );
...
export class UserPosition {
    ...
    constructor(
        ...
        this.holdPoolAmount =
            userPosition.holdPoolAmount.toBigNumberWithDecimals(
                userPosition.isLong ? baseCoinDecimals : stableCoinDecimals,
            );
...
export class UserOrder {
    ...
    constructor(userOrder: UserOrderAccount, coinDecimals: number) {
        ...
        this.acceptablePrice =
            userOrder.acceptablePrice.toBigNumberWithDecimals(
                C.PRICE_EXPONENT_NUMBER,
            );
