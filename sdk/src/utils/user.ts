...
export class BumpinUserUtils {
    ...
    public static getMyPosition(me: UserAccount, isPortfolioMargin?: boolean): UserPosition[] {
    ...
    public static getMyOrder(me: UserAccount, isPortfolioMargin?: boolean): UserOrder[] {
