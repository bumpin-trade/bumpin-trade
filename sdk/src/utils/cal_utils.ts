...
//
//
// BN.prototype.toUsd = function (tokenPrice: BN, decimals: BN) :BN{
//     return this.mul(tokenPrice).mul(TEN.pow(TEN)).div(TEN.pow(new BN(decimals)));
// }
//
// BN.prototype.toToken = function (tokenPrice: BN, decimals: BN) {
//     return this.mul(decimals).div(tokenPrice.mul(TEN.pow(new BN(10))));
// }
