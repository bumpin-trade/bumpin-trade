...
export class OrderSide {
  ...
  toString() {
    return isEqual(this, OrderSide.NONE)
      ? "None"
      : isEqual(this, OrderSide.LONG)
      ? "Long"
      : "Short";
  }
}
...
export class PositionSide {
  ...
  toString() {
    return isEqual(this, PositionSide.NONE)
      ? "None"
      : isEqual(this, PositionSide.INCREASE)
      ? "Increase"
      : "Decrease";
  }
}
...
export class OrderType {
  ...
  toString() {
    return isEqual(this, OrderType.NONE)
      ? "None"
      : isEqual(this, OrderType.MARKET)
      ? "Market"
      : isEqual(this, OrderType.LIMIT)
      ? "Limit"
      : "Stop";
  }
}
...
export class StopType {
  ...
  toString() {
    return isEqual(this, StopType.NONE)
      ? "None"
      : isEqual(this, StopType.StopLoss)
      ? "StopLoss"
      : "TakeProfit";
  }
}
